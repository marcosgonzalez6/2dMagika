...
public class Images {
	...
	public static BufferedImage[] SkelyEnemy2_right;
	public static BufferedImage[] SkelyEnemy2_left;
	public static BufferedImage[] SkelyEnemy2_front;
	public static BufferedImage[] SkelyEnemy2_back;
	...
	public static BufferedImage bombExplosion;
	...
	public Images() {
		...
		SpriteSheet newEnemySheet = new SpriteSheet(Images.loadImage("/Sheets/newEnemySheet.png"));
		...
		SkelyEnemy2_left = new BufferedImage[4];
		SkelyEnemy2_right = new BufferedImage[4];
		SkelyEnemy2_front = new BufferedImage[4];
		SkelyEnemy2_back = new BufferedImage[4];
		...
		try {
			...
			bone = ImageIO.read(getClass().getResourceAsStream("/Sheets/bone.png"));
			cactus = ImageIO.read(getClass().getResourceAsStream("/Sheets/cactus.png"));
			manna = ImageIO.read(getClass().getResourceAsStream("/Sheets/stars.png"));
			...
			bombExplosion = ImageIO.read(getClass().getResourceAsStream("/Sheets/bombSheet.png"));
			sign = ImageIO.read(getClass().getResourceAsStream("/Sheets/sign2.png"));
			infosign = ImageIO.read(getClass().getResourceAsStream("/Sheets/infosign.png"));;
			heart = ImageIO.read(getClass().getResourceAsStream("/Sheets/heart.png"));
			finishLine = ImageIO.read(getClass().getResourceAsStream("/Sheets/finishLine1.png"));

			bomb = ImageIO.read(getClass().getResourceAsStream("/Sheets/bomb.png"));
			...
			//New Skely Enemy 
			SkelyEnemy2_front[0]=newEnemySheet.crop(width*0,height*0,width,height);
			SkelyEnemy2_front[1]=newEnemySheet.crop(width*1,height*0,width,height);
			SkelyEnemy2_front[2]=newEnemySheet.crop(width*2,height*0,width,height);
			SkelyEnemy2_front[3]=newEnemySheet.crop(width*3,height*0,width,height);

			SkelyEnemy2_left[0]=newEnemySheet.crop(width*0,height*1,width,height);
			SkelyEnemy2_left[1]=newEnemySheet.crop(width*1,height*1,width,height);
			SkelyEnemy2_left[2]=newEnemySheet.crop(width*2,height*1,width,height);
			SkelyEnemy2_left[3]=newEnemySheet.crop(width*3,height*1,width,height);

			SkelyEnemy2_right[0]=newEnemySheet.crop(width*0,height*2,width,height);
			SkelyEnemy2_right[1]=newEnemySheet.crop(width*1,height*2,width,height);
			SkelyEnemy2_right[2]=newEnemySheet.crop(width*2,height*2,width,height);
			SkelyEnemy2_right[3]=newEnemySheet.crop(width*3,height*2,width,height);

			SkelyEnemy2_back[0]=newEnemySheet.crop(width*0,height*3,width,height);
			SkelyEnemy2_back[1]=newEnemySheet.crop(width*1,height*3,width,height);
			SkelyEnemy2_back[2]=newEnemySheet.crop(width*2,height*3,width,height);
			SkelyEnemy2_back[3]=newEnemySheet.crop(width*3,height*3,width,height);
