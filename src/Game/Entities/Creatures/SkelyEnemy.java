...
import Game.Entities.Statics.Bomb;
...
public class SkelyEnemy extends CreatureBase  {
	...
	public void render(Graphics g) {
		...
		if(healthcounter<=120){
			...
			}else if(this.getHealth() > 0 && this.getHealth() <= 10){
	...
	@Override
	public void die() {
		handler.getWorld().getItemManager().addItem(Item.boneItem.createNew((int)x + bounds.x,(int)y + bounds.y,1));
	}
}
